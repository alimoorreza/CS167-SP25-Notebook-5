...
- Build an **MLP** that has this structure (the exact number of parameters is given in [the part 1 starter notebook](https://github.com/alimoorreza/CS167-SP25-Notebook-5/blob/main/Notebook5_part1_starter.ipynb) as suggestions):
  - One input layer 
  - Three hidden layers
  - One output layer
- Build a **CNN** that has this structure (the exact number of parameters is given in [the part 2 starter notebook](https://github.com/alimoorreza/CS167-SP25-Notebook-5/blob/main/Notebook5_part2_starter.ipynb) as suggestions):
  - Conv layer 1
  - Conv layer 2
  - Flatten layer
